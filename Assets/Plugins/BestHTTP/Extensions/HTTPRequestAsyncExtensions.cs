...
namespace BestHTTP
{
    public static class HTTPRequestAsyncExtensions
    {
        ...
        public static Task<Texture2D> GetAsTexture2DAsync(this HTTPRequest request, CancellationToken token = default, Texture2D fallbackTex = null)
        {
